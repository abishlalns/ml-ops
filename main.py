...
def generate_gherkin_code(gherkin_generation_request_body: GherkinGenerationRequestBody):
    """ Generate Gherkin code based on the provided requirement text. """
    gherkin_generation_success_response = gherkin_from_ml(gherkin_generation_request_body)
...
async def get_model_metadata():
    ...
    return ModelMetadataResponse(
        ...
        version="1.0.0",
        description="This is the Curiosity Model used for Gherkin code generation.",
        author="Curiosity",
